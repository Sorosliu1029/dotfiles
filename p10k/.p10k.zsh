# Generated by Powerlevel10k configuration wizard on 2025-02-21 at 14:59 CST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 4117.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, angled separators, sharp heads, flat tails, 2 lines, dotted, no frame, lightest-ornaments, compact, many icons, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=#FEE11B
  ...
  function prompt_srun_remaining() {
    ...
    p10k segment -f 33 -t "Srun remain: ${jobs}"
  }
